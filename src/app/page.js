...
export default function Home() {
  return (
    <div className="w-full flex flex-col items-center justify-center">     
      ...
      <div className="w-full h-40 flex items-center justify-center bg-gray-950 font-bold text-lg px-6 py-3 rounded-lg shadow-md 
     ...
     <div className = "h-20">
        ...
        Endereço: QI 15, CEP 72135-150</h1>
        </div>
    </div>
  );
}
